...
def afis(a,b,c,d): #procedura de afisare a unui text(t) in mod grafic in diverse pozitii(a,b) si intermitent rosu-galben de d ori
    turtle.pu() #procedure to display a text(t) graphically in various position(a,b) and flashing red-yellow of d times
    turtle.goto(a,b)
    turtle.pd()
    for i in range(d):
        if i % 2 == 0:
